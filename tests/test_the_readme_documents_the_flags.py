...
A flag nobody can discover is a flag nobody uses.  agentdiff grew a `--strict` and a `--pre-commit`,
...
command line belonging to agentdiff itself.  READMEs discuss other programs — the
...
it as a flag agentdiff has lost.
"""
...
from agentdiff.cli import _build_parser as build_parser
...
FOREIGN = {"git", "pip", "python3", "stillworks", "cd", "unedit", "agentwatch", "agentlog"}
